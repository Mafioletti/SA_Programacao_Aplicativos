class Agendamento:
    ...
    def reverte_tupla(tupla):
        id_age, cliente, telefone, servico, preco, barbeiro, data, horario, status = tupla
        return Agendamento(cliente=cliente, telefone=telefone, servico=servico, preco=preco, barbeiro=barbeiro, data=data, horario=horario, status=status, id=id_age)
